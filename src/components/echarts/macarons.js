...
(function(root, factory) {
  ...
  echarts.registerTheme("macarons", {
    ...
    toolbox: {
      iconStyle: {
        normal: { borderColor: "#2ec7c9" },
        emphasis: { borderColor: "#18a4a6" }
      }
    },
    ...
    timeline: {
      lineStyle: { color: "#008acd", width: 1 },
      itemStyle: {
        normal: { color: "#008acd", borderWidth: 1 },
        emphasis: { color: "#a9334c" }
      },
      controlStyle: {
        normal: { color: "#008acd", borderColor: "#008acd", borderWidth: 0.5 },
        emphasis: { color: "#008acd", borderColor: "#008acd", borderWidth: 0.5 }
      },
      checkpointStyle: {
        color: "#2ec7c9",
      ...
      label: {
        normal: { textStyle: { color: "#008acd" } },
        emphasis: { textStyle: { color: "#008acd" } }
      }
    },
